...
export const LookingForRolesFilterDropdown = () => {
  ...
  return (
    <div className="dropdown dropdown-top md:dropdown-bottom md:dropdown-end lg:dropdown-start xl:dropdown-center">
      ...
      <ul
        tabIndex={0}
        className="flex flex-row dropdown-content menu bg-base-200 rounded-box z-1 w-full max-h-60 md:w-140 md:max-h-fit overflow-y-scroll scrollbar-thin lg:w-200 mt-2 p-4 border border-base-100"
      >
        <div>
