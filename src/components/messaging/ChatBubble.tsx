  ...
  return (
    <>
      <div
        className={
          isSentByCurrentUser
            ? "text-white max-w-[95%] sm:max-w-[85%] md:max-w-[70%] bg-primary px-4 py-2 rounded-t-3xl rounded-bl-3xl rounded-br-md self-end cursor-pointer break-all select-none"
            : "max-w-[95%] sm:max-w-[85%] md:max-w-[70%] bg-base-300 px-4 py-2 rounded-t-3xl rounded-bl-md rounded-br-3xl self-start cursor-pointer break-all select-none"
        }
        onClick={() => {
      ...
      {hiddenItemsVisible && (
        <p className={isSentByCurrentUser ? "self-end text-accent mt-[-4px]" : "self-start text-accent mt-[-4px]"}>
