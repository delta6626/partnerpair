...
export const MaxChatsReachedModal = () => {
  const closeModal = () => {
  ...
  return (
    <dialog id={MODALS.MAX_CHATS_REACHED_ERROR_MODAL.ID} className="modal">
      <div className="modal-box bg-base-300 border border-base-100">
        <div className="flex items-center gap-2">
          <AlertCircle size={20} className="text-error/60" />
          <h1 className="text-lg font-medium">{MODALS.MAX_CHATS_REACHED_ERROR_MODAL.TITLE}</h1>
        </div>
        <p className="mt-2 text-accent">{MODALS.MAX_CHATS_REACHED_ERROR_MODAL.DESCRIPTION}</p>
