          ...
          <div className="py-8 w-full max-w-200 mt-4">
            ...
            <section className="mt-8">
              ...
              <section>
                ...
                <h1>Providing this information is optional but strongly recommended for effective matching.</h1>
              </section>
              ...
              <section>
                ...
                <h1>This data is collected automatically and is required for core platform functionality.</h1>
              </section>
              ...
              <section>
                ...
                <h1>This data is used solely to provide messaging functionality and maintain platform integrity.</h1>
              </section>
            ...
            <section className="mt-8">
              ...
              <ul className="list-disc pl-4">
                ...
                <li>Owner: Individual operator based in the United Arab Emirates</li>
              </ul>
            </section>
          </div>
        </div>
