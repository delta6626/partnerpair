  ...
  return (
    <div className="w-full font-inter min-h-[100vh] bg-base-300">
      ...
      <section className="py-16 flex flex-col items-center gap-16 paddingContainer">
        ...
        <div className="w-full flex flex-col gap-8 lg:flex-row justify-center">
          <StepCard
            step="01"
      ...
      <section
        id={HOME.FEATURES_SECTION_ID}
        className="py-16 flex flex-col xl:flex-row items-center justify-between gap-16 paddingContainer"
      >
